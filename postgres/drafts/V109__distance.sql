...
CREATE TYPE distance.class AS ENUM (
  'direct',
  'standard candle',
  'standard ruler',
  'standard siren'
...
CREATE TABLE distance.data (
  ...
  modulus real NOT NULL CHECK (
    modulus > 15
    and modulus < 40
  ),
  em_modulus real CHECK (
    em_modulus > 0
    and em_modulus < 0.5
  ),
  ep_modulus real CHECK (
    ep_modulus > 0
    and ep_modulus < 0.5
  ),
...
SELECT
  ...
  t.datatype,
  obsol.bib IS NULL
  and excl.id IS NULL AS isok,
  greatest(
    d.modification_time,
    obsol.modification_time,
...
---------- Methods --------------------------------
INSERT INTO
  distance.method (id, class, short, description)
VALUES
  (
    'DEB',
    'direct',
  ...
  (
    ...
    'direct',
    'Dense Shell Method',
    'The Dense Shell Method relies on observations of an expanding dense shell in SN IIn and allows one to determine the linear size of such a shell in absolute units, and hence the distance to it, without addressing the cosmological distance ladder.'
  ),
  (
    'EPM',
    'direct',
    'Expanding Photosphere Method',
    'The Expanding Photosphere Method (EPM) is a geometric distance determination technique based on comparing radial velocities with proper motion of an expanding shell after supernova explosion.'
  ),
  (
    'ESM',
    'direct',
    'Expanding Shock front Method',
    'The Expanding Shock front Method (ESM) is a geometric distance determination technique based on comparing radial velocities with proper motion of an expanding shell after supernova explosion.'
  ),
  (
    'Maser',
    'direct',
    'Maser emission in an accretion disk',
  ...
  (
    ...
    'The SEAM is similar to the EPM in spirit, but it avoids the use of dilution factors and color temperatures. Velocities are determined accurately by actually fitting synthetic and observed spectra. The radius is still determined by the relationship R = vt (which is an excellent approximation because all SNe quickly reach homologous expansion), and the explosion time is found by demanding self-consistency. The SEAM uses all the spectral information available in the observed spectra simultaneously, which broadens the base of parameter determination.'
  ),
  (
    'Asteroseismic',
    'standard candle',
    'Asteroseismic distance',
    'A method  is based on a relation between the frequency of maximum oscillation power Vmax, the large frequency separation dV, the apparent magnitude V, the metallicity Z, and the distance modulus (m-M)0.'
  ),
  (
    'BBSLF',
    'standard candle',
    'Luminosity Function of Brightest Blue Stars',
    NULL
  ),
  (
    'BRSLF',
    'standard candle',
    'Luminosity Function of Brightest Red Supergiants',
    NULL
  ),
  (
    'BS',
    'standard candle',
    'mean absolute magnitude of Brightest Stars',
    NULL
  ),
  (
    'BS3B',
    'standard candle',
    'mean absolute magnitude of three Brightest Blue Stars',
    NULL
  ),
  (
    'BS3R',
    'standard candle',
    'mean absolute magnitude of three Brightest Red Stars',
    NULL
  ),
  (
    'BHB',
    ...
    'This method uses the blue horizontal branch (BHB) stars as standard candles. Carretta et al. (2000, ApJ, 533, 215) give the relation between absolute magnitude and metallicity of HB: MV(HB) = (0.13±0.09)([Fe/H]+1.5) + (0.54±0.07).'
  ),
  (
    'HB',
    'standard candle',
    'Horizontal Branch stars',
    'This method uses the horizontal branch (HB) stars as standard candles. Carretta et al. (2000, ApJ, 533, 215) give the relation between absolute magnitude and metallicity of HB: MV(HB) = (0.13±0.09)([Fe/H]+1.5) + (0.54±0.07).'
  ),
  (
    'RHB',
    'standard candle',
  ...
  (
    ...
    'The Flux-weighted Gravity-Luminosity Relationship (FGLR) is a technique to derive the distance from a spectral analysis of the B and A supergiant stars (Kudritzki et al., 2008, ApJ, 681, 269). It is based on a tight correlation between the absolute bolometric magnitude and the flux-weighted gravity, g/Teff^4.'
  ),
  (
    'GCLF',
    'standard candle',
  ...
  (
    'GCR',
    'standard ruler',
    'Globular Cluster half-light Radii',
  ...
  (
    'MS',
    'standard candle',
    'Main Sequence with clear turn-off',
  ...
  (
    'Miras',
    'standard candle',
    'period-luminosity relation for Miras',
  ...
  (
    'RSV',
    'standard candle',
    'period-luminosity relation for Red Supergiant Variable stars',
  ...
  (
    'spec',
    'standard candle',
    'Spectroscopic classification of individual stars',
    NULL
  ),
  (
    'BWM',
  ...
  (
    ...
    'standard ruler',
    'Fundamental Plane',
    'The Fundamental Plane (FP) is a distance determination method for early-type galaxies based on relation between the absolute magnitude, effective radius, velocity dispersion, and mean surface brightness. log D = logre - 1.24 logσ + 0.82 log<I>e +0.173 (Kelson et al. 2000, ApJ, 529, 768).'
  ),
  (
    'SB-M',
    'standard candle',
    'Surface Brightness-total Magnitude relation',
    'The Surface Brightness-total Magnitude relation can be considered as rough distance estimate for small mass elliptical galaxies.'
  ),
  (
    'Sersic-M',
    'standard candle',
    'Sersic index-total Magnitude relation',
    'The Sersic index-total Magnitude relation (Sersic-M) can be considered as rough distance estimate for small mass elliptical galaxies.'
  ),
  (
    'Sosie',
    'standard candle',
