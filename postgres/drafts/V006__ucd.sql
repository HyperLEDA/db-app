...
----------------------------------------------
------ UCD 1+ --------------------------------
CREATE TABLE common.ucd (
  id	text	PRIMARY KEY
, description	text	NOT NULL
) ;

COMMENT ON TABLE common.ucd	IS 'Unified Content Descriptors (UCD 1+)' ;
COMMENT ON COLUMN common.ucd.id	IS '{"description" : "UCD" , "ucd" : "meta.id;meta.ucd"}' ;
COMMENT ON COLUMN common.ucd.description	IS '{"description" : "Important comments on the object" , "ucd" : "meta.note"}' ;

INSERT INTO common.ucd VALUES
...
, ( 'meta.ref.ivoid' , 'Related to an identifier as recommended in the IVOA (dereferenceable)' )
...
, ( 'phys.fluence' , 'Particle energy received by a surface per unit area integrated over time' )
...
, ( 'pos.az' , 'Position in alt-azimuth frame' )
, ( 'pos.az.alt' , 'Alt-azimuth altitude' )
, ( 'pos.az.azi' , 'Alt-azimuth azimuth' )
, ( 'pos.az.zd' , 'Alt-azimuth zenith distance' )
...
, ( 'pos.centroid' , 'Related to the centroid of a measure.' )
...
, ( 'pos.phaseAng' , 'Phase angle, e.g. elongation of earth from sun as seen from a third celestial object' )
