...
SELECT meta.setparams('photometry', 'isophotal', 'band',  '{"description":"Calibrated passband ID", "ucd":"instr.filter"}') ;
SELECT meta.setparams('photometry', 'isophotal', 'isophote', '{"description":"Isophote level", "unit":"mag/arcmin2", "ucd":"phot.mag.sb"}') ;
SELECT meta.setparams('photometry', 'isophotal', 'mag',   '{"description":"Magnitude inside give isophote", "unit":"mag", "ucd":"phot.mag"}') ;
SELECT meta.setparams('photometry', 'isophotal', 'e_mag', '{"description":"Error of the isophotal magnitude", "unit":"mag", "ucd":"stat.error;phot.mag"}') ;
