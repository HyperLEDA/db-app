...
INSERT INTO common.filter VALUES
 ('UV2000',,,150,,'Ultraviolet between 100 and 200 nm',,)
,('Opt',,,,,'Optical part of the spectrum',,)
,('OptB',,,450,,'Optical band between 400 and 500 nm',,)
,('OptV',,,550,,'Optical band between 500 and 600 nm',,)
,('OptR',,,680,,'Optical band between 600 and 750 nm',,)
...
,('C',,,391,110,'C','https://ui.adsabs.harvard.edu/abs/1976AJ.....81..228C',)
,('Y',,,1020,120,'Y',,)
,('K',,,2200,590,'K','https://ui.adsabs.harvard.edu/abs/1965CoLPL...3...73J',)
,('Ks',,,2150,300,'K (short)',,)
,('H_Aar',,'Aaronson',,,'H band 1.6mu',,)
,('S850',,,850000,,'S850',,)
,('21cm',,,,,'21 cm HI line 1420 Mhz','https://ui.adsabs.harvard.edu/abs/1991rc3..book.....D',)
,('S1.4GHz',,,,,'S1.4GHz',,)
,('S408MHz',,,,,'S408MHz',,)
,('u_CFHT','MegaCam u','MegaCam',369.262,45.642,'MegaCam 3rd generation u filter (installed in 2015)',,'MegaCam.u')
,('g_CFHT','MegaCam g','MegaCam',482.401,153.224,'MegaCam 3rd generation g filter (installed in 2015)',,'MegaCam.g')
,('r_CFHT','MegaCam r','MegaCam',642.546,147.766,'MegaCam 3rd generation r filter (installed in 2015)',,'MegaCam.r')
,('i_CFHT','MegaCam i','MegaCam',772.106,153.812,'MegaCam 3rd generation i filter (installed in 2015)',,'MegaCam.i')
,('z_CFHT','MegaCam z','MegaCam',900.478,77.401,'MegaCam 3rd generation z filter (installed in 2015)',,'MegaCam.z')
,('Ks_CFHT','Wircam Ks','Wircam',2149.746,327.046,'Wircam Ks',,'Wircam.Ks')
,('pg',,,,,'Photographic magnitude (Holmberg)',,)
,('pv',,,,,'Photovisual magnitude (Holmberg)',,)
,('F475W','ACS_WFC F475W','ACS-WFC',480.231,139.886,'F475W filter for HST ACS_WFC',,'ACS_WFC.F475W')
,('F606W','ACS_WFC F606W','ACS-WFC',603.573,225.34,'F606W filter for HST ACS_WFC',,'ACS_WFC.F606W')
,('F625W','ACS_WFC F625W','ACS-WFC',635.246,138.928,'F625W filter for HST ACS_WFC',,'ACS_WFC.F625W')
,('F775W','ACS_WFC F775W','ACS-WFC',773.077,151.731,'F775W filter for HST ACS_WFC',,'ACS_WFC.F775W')
,('F814W','ACS_WFC F814W','ACS-WFC',812.921,209.815,'F814W filter for HST ACS_WFC',,'ACS_WFC.F814W')
,('F850LP','ACS_WFC F850LP','ACS-WFC',908.026,127.35,'F850LP filter for HST ACS_WFC',,'ACS_WFC.F850LP')
,('F814W_PC','WFPC2-PC F814W','WFPC2-PC',808.047,165.652,'F814W filter for HST WFPC2 planetary camera (detector 1)',,'WFPC2-PC.F814W')
,('F814W_WF','WFPC2-WF F814W','WFPC2-WF',808.663,167.613,'F814W filter for HST WFPC2 wide field camera (detector 4)',,'WFPC2-WF.F814W')
,('B_J',,,456.8,123.1,'Photographic B_J (SuperCOSMOS) from ADPS','https://ui.adsabs.harvard.edu/abs/1980PASP...92..746C',)
,('Rg',,,658.5,72.9,'Gunn-Oke R-band magnitude from the POSS II from ADPS','https://ui.adsabs.harvard.edu/abs/1980PASP...92..746C',)
,('r_T&G',,,651.3,85.5,'r-band Thuan & Gunn (1976) magnitude from ADPS','https://ui.adsabs.harvard.edu/abs/1980PASP...92..746C',)
,('R_F',,,669.3,46.2,'Photographic R_F from ADPS','https://ui.adsabs.harvard.edu/abs/1980PASP...92..746C',)
,('H',,,1650,270,'H band (Bessell & Brett, 1988) from ADPS',,)
,('K'',,,2110,320,'K' band (Tokunaga et al. 2002) from ADPS',,)
...
,('I_Cousins','Cousins I','Cousins',,,'Cousins I generic filter','https://ui.adsabs.harvard.edu/abs/1976MmRAS..81...25C','Cousins.I')
,('T1',,,633,80,'T1','https://ui.adsabs.harvard.edu/abs/1976AJ.....81..228C',)
,('i_BATC',,,665.59,49.1,'9: i-band of the Beijing-Arizona-Taiwan-Connecticut Sky Survey','https://ui.adsabs.harvard.edu/abs/2000PASP..112..691Y',)
,('Halpha',,,656.28,,'H-alpha line','https://ui.adsabs.harvard.edu/abs/2013AJ....145..101K',)
,('I_DENIS','DENIS I','DENIS',793.037,131.111,'DENIS I',,'DENIS.I')
,('J_DENIS','DENIS J','DENIS',1235.743,199.111,'DENIS J',,'DENIS.J')
,('Ks_DENIS','DENIS Ks','DENIS',2162.634,330.194,'DENIS Ks',,'DENIS.Ks')
,('I_Mathewson','Mathewson I','Mathewson',,,'I band for Mathewson system',,)
...
,('Y_UKIDSS','UKIDSS J','UKIDSS',1032.794,102.681,'UKIDSS Y',,'UKIDSS.Y')
,('H_UKIDSS','UKIDSS H','UKIDSS',1642.288,295.217,'UKIDSS H',,'UKIDSS.H')
,('K_UKIDSS','UKIDSS K','UKIDSS',2213.199,351.137,'UKIDSS K',,'UKIDSS.K')
