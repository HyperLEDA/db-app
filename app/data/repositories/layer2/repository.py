...
class Layer2Repository(postgres.TransactionalPGRepository):
    ...
    def query_pgc(
        ...
        # Build CTEs for each catalog table
        cte_parts = []
        select_parts = []
        join_parts = []
        ...
        for i, catalog in enumerate(catalogs):
            ...
            # Join parts (FULL OUTER JOIN to maintain same behavior as original FULL JOIN)
            if i == 0:
        ...
        # Parameters: pgc_numbers repeated for each catalog, plus limit and offset
